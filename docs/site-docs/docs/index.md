...
We welcome contributions of all kinds — bug reports, feature requests, documentation improvements, and code. Please see our [Contributing guide](operations/contributing.md) for guidelines.
...
This project is licensed under the **Apache License 2.0** — see the [LICENSE](https://github.com/spectrayan/promptly/blob/main/LICENSE) file for details.
