...
public class SystemProjectSeeder {
    ...
    private reactor.core.publisher.Mono<com.promptly.prompt.domain.model.Prompt> seedPrompt(
        ...
        var prompt = com.promptly.prompt.domain.model.Prompt.builder()
                .name(promptName)
                .description("System prompt for the " + feature + " feature. " +
                             "Edit this prompt to customize AI behavior.")
                .projectId(projectId)
                .contentFormat(com.promptly.prompt.domain.model.ContentFormat.MARKDOWN)
                .tags(new java.util.HashSet<>(java.util.Set.of("system", feature)))
                .currentVersion(0)
                .status(com.promptly.prompt.domain.model.PromptStatus.DRAFT)
                .build();
