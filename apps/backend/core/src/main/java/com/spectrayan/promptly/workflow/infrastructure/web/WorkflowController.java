package com.spectrayan.promptly.workflow.infrastructure.web;

import com.spectrayan.promptly.infrastructure.in.web.api.WorkflowsApi;
import com.spectrayan.promptly.infrastructure.in.web.dto.ApproveRejectRequest;
import com.spectrayan.promptly.infrastructure.in.web.dto.SubmitReviewRequest;
import com.spectrayan.promptly.infrastructure.in.web.dto.StepAction;
import com.spectrayan.promptly.infrastructure.in.web.dto.WorkflowResponse;
import com.spectrayan.promptly.infrastructure.in.web.dto.WorkflowStatus;
import com.spectrayan.promptly.infrastructure.in.web.dto.WorkflowStepResponse;
import com.spectrayan.promptly.workflow.application.port.in.*;
...
public class WorkflowController implements WorkflowsApi {
    ...
    private WorkflowResponse toResponse(Workflow workflow) {
        List<WorkflowStepResponse> steps = (workflow.getSteps() != null ? workflow.getSteps() : java.util.Collections.<com.spectrayan.promptly.workflow.domain.model.WorkflowStep>emptyList()).stream()
                .map(s -> {
