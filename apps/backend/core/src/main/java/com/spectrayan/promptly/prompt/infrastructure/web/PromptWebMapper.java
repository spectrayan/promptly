package com.spectrayan.promptly.prompt.infrastructure.web;

import com.spectrayan.promptly.infrastructure.in.web.dto.ContentFormat;
import com.spectrayan.promptly.infrastructure.in.web.dto.PromptResponse;
import com.spectrayan.promptly.infrastructure.in.web.dto.PromptSummaryResponse;
import com.spectrayan.promptly.infrastructure.in.web.dto.VersionResponse;
...
public class PromptWebMapper {
    ...
    private com.spectrayan.promptly.infrastructure.in.web.dto.PromptStatus toDtoStatus(
            com.spectrayan.promptly.prompt.domain.model.PromptStatus domainStatus) {
        if (domainStatus == null) {
            return com.spectrayan.promptly.infrastructure.in.web.dto.PromptStatus.DRAFT;
        }
        return com.spectrayan.promptly.infrastructure.in.web.dto.PromptStatus.fromValue(domainStatus.name());
    }
