...
class ProjectResponse(BaseModel):
    ...
    member_count: Optional[StrictInt] = Field(default=None, description="Number of members in this project", alias="memberCount")
    prompt_count: Optional[StrictInt] = Field(default=None, description="Number of prompts in this project", alias="promptCount")
    created_by: StrictStr = Field(alias="createdBy")
    created_at: datetime = Field(alias="createdAt")
    updated_at: Optional[datetime] = Field(default=None, alias="updatedAt")
    __properties: ClassVar[List[str]] = ["id", "name", "description", "tags", "memberCount", "promptCount", "createdBy", "createdAt", "updatedAt"]
