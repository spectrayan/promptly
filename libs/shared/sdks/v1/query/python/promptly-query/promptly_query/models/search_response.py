...
class SearchResponse(BaseModel):
    ...
    score: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Relevance/similarity score (0.0–1.0)")
    __properties: ClassVar[List[str]] = ["promptId", "name", "description", "score"]
