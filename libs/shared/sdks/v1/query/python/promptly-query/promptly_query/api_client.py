...
from promptly_query.configuration import Configuration
from promptly_query.api_response import ApiResponse, T as ApiResponseT
import promptly_query.models
from promptly_query import rest
from promptly_query.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(promptly_query.models, klass)
